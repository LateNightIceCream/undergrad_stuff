...
p9 <- ggplot(data.frame(x=c(0, 2),y=c(0,2)), aes(x,y)) +
        ...
        theme(axis.title.y = element_text(angle = 0, vjust = 0.3819660112501051, size=16.18, color="#0000007F"), axis.text.y = element_text(size = 32.36, color = c("grey60", LcolorNoAlpha))) + # rotate axis title
