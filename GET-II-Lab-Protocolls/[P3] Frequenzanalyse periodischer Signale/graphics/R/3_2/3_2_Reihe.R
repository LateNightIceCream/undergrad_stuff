...
data <-read.csv(file = "/home/zamza/Documents/HS/Semester 2/GET II/Labs/[P3] Frequenzanalyse periodischer Signale/graphics/3_2.csv")
...
p <- ggplot(data.frame(x=c(0,2), y=c(0,2)), aes(x=x)) +
        ...
        ggtitle(bquote("Amplitudenspektrum der zweiweg-gleichgerichteten cos-Spannung, Rot: theoretische Werte"))+
...
pdf("3_2_ASpektrum.pdf", width = output_width, height = output_height, )
p
