...
(/usr/share/texmf-dist/tex/generic/oberdiek/se-ascii-print.def) [1] (./OTDR.aux
)

Package rerunfilecheck Warning: File `OTDR.out' has changed.
(rerunfilecheck)                Rerun to get outlines right
(rerunfilecheck)                or use package `bookmark'.

 )
Output written on OTDR.pdf (1 page).
Transcript written on OTDR.log.
