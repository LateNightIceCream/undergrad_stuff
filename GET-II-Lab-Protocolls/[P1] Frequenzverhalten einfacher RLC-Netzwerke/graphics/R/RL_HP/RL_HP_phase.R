...
pdf("RL_HP_phase.pdf", width = output_width, height = output_height, )
...
p9 <- ggplot(displaydata, aes(dataX, dataY)) +
        ...
        scale_y_continuous(limits=c(0, pi/2), breaks = c(0, pi/2, pi/4, 1/3*pi, 1/6*pi, 1/12*pi, 5/12*pi), labels = c(0, 90, 45, 60, 30, 15, 75) ) +
