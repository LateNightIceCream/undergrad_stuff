...
void main()
{
    ...
    for(;;)
    {
        ...
        sprintf( displayStr, "%.3f %cC", R_to_degC(ADC_to_R(dfUinVolt)), 223 );
        sprintf( displayStr_DS, "%.3f %cC", R_to_degC(ADC_to_R(dfUinVolt))-R_to_degC_DS(ADC_to_R_DS(dfUinVolt)), 223 );
