...
/* ******************************************************************
Version c mit Uebertragung von reinen Zahlenwerten
* // alt: sprintf(TransmitBuffer, "Sample: %lu mV\r\n",  Output);
* // neu:
* sprintf(TransmitBuffer, "%lu\r\n",  Output);
*/ 

/*
Version b mit Abtastfrequenz von ca. 10 Hz:
* Eingefügt wurde eine einfache Verzoegerung von 99ms CyDelay(99); 
* Die Typkennung bei der Umwandlung des Ergebnisses output in einen String 
* wurde von %d in %lu geaendert.
*/ 
